...
// Styled time input with icon prefix
function TimeInput({ value, onChange }: { value: string; onChange: (v: string) => void }) {
  return (
    <div className="flex items-center border border-gray-200 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-indigo-500 focus-within:border-indigo-500 bg-white transition-shadow">
...
export default function StaffWorkingHoursPage() {
  ...
  const addBlock = useMutation({
    ...
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ['my-blocked-periods'] });
      ...
      <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
        ...
        {blockOpen && (
          <div className="px-5 py-4 border-b border-gray-100 bg-slate-50 space-y-4">
            ...
            {/* Saat aralığı (sadece "Belirli Saatler") */}
